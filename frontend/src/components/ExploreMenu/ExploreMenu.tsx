    ...
    return (
        <div className="explore-menu" id="explore-menu">
            ...
            <p className="explore-menu-text">Choose from a diverse menu featuring a delectable array of dishes crafted
                ...
                culinary expertise. Our mission to satisfy your cravings and elevate your dining experience, one
            ...
            <div className="explore-menu-list">
                {menu_list.map((item, index) => {
                    return (
                        ...
                        >
                            <img className={category === item.menu_name ? "active" : ""} src={item.menu_image} alt="Photo of food"/>
                            <p>{item.menu_name}</p>
                        </div>
                    )
                })}
